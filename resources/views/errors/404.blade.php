...
<div class="error-page">
    ...
    <div class="error-content">
        ...
        <p>
            ...
            {{ trans('adminlte_lang::message.mainwhile') }} <a href='{{ url('/backend/dashboard') }}'>{{ trans('adminlte_lang::message.returndashboard') }}</a> {{ trans('adminlte_lang::message.usingsearch') }}
        </p>
